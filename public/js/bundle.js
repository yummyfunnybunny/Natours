...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoieXVtbXlmdW5ueWJ1bm55IiwiYSI6ImNrODZwNzQydDA1bjEzZW15NTRqa2NpdnEifQ.6y8NFU2qjw6mTgINZYaRyg'; // ANCHOR -- Create MapBox Map --
  ...
  var bounds = new mapboxgl.LngLatBounds(); // ANCHOR -- Add Location Markers --
  // this will add all of locations that we saved above onto the map

  locations.forEach(function (location) {
    // Create Your Custom Marker
    var marker = document.createElement('div');
    marker.className = 'marker'; // Add Markers to map

    new mapboxgl.Marker({
      element: marker,
      anchor: 'bottom' // sets the origin of the sprite you are generating

    }).setLngLat(location.coordinates).addTo(map); // Add popup info

    new mapboxgl.Popup({
      offset: 30,
      closeButton: false,
      closeOnClick: false
    }).setLngLat(location.coordinates).setHTML("<p>Dat ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // set timer for 1.5 seconds...
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); // refresh the window aftert 1 second once the data was updated successfully
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51I9ZjlBcVHcNRhZkS6AjIVbFJjCfczEIlX936bl0ZMVfqZheO6m2x66gI0VIramnHRsAVEUU3OfeWp5exeRLIWUQ00uusNH9Dd');
            _context.prev = 1;
            _context.next = 4;
...
var bookBtn = document.getElementById('book-tour'); // ANCHOR -- Aquire Locations --
...
if (signupForm) {
  ...
  signupForm.addEventListener('submit', function (e) {
    ...
    if (password !== passwordConfirm) {
      (0, _alerts.showAlert)('error', 'Passwords do not match! Please retry...');
    } else {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // create a FormData object that we can use to append multiple types of data to
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // set the 'save password' button to  'updating...' while the await is being performed

              document.querySelector('.btn--save-password').textContent = 'Updating...'; // save the input values from the password reset form

              passwordCurrent = document.getElementById('password-current').value;
              newPassword = document.getElementById('password').value;
              newPasswordConfirm = document.getElementById('password-confirm').value; // call the 'updateSettings' function with the new password info
            ...
            case 7:
              ...
              document.querySelector('.btn--save-password').textContent = 'Save password'; // reset the password fields to empty after we're done
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // console.log(`BookBtn Click: ${tourId}`);
